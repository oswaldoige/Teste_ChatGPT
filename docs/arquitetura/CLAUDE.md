...
- Antes de redigir qualquer minuta, busque modelos e referencias na pasta `${GABINETE_ACERVO}`, priorizando a subpasta tematica mais aderente ao caso concreto.
- Antes de qualquer busca ampla, consulte primeiro a curadoria reduzida em `${GABINETE_ACERVO}\00_PRIORITARIOS_AUTOMACAO`.
...
- Em `${GABINETE_ACERVO}\modelos_variados`, consulte, quando pertinente, os arquivos `98 - REFERENCIA - JTRAMOS.pdf` e `98 - REFERENCIA - MODELOS CONSECTARIOS TJRJ TEMA1368.pdf`, sobretudo em decisoes complexas e sentencas.
